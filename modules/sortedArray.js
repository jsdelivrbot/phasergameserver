...
SortedArray.prototype._find = function(item) {
	//returns the index of the item or the index of where it would fit
...
SortedArray.prototype.select = function(min, max) {
	//not working
